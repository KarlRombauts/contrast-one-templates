...
- [ ] Option B: Use 1 space after a period everywhere (gynae/t3twins style)
...
- [ ] Option B: Without spaces, no prefix (all other exams): `"30x20x15mm"`
...
- [ ] Option B: Use past tense for all exams ("was/were")
...
- [ ] Option A: Use pe12week version (proper spaces, null checks) for all exams
...
- [ ] Option B: Use pe12week/t3 style (measurements first, ", clear of the cervix" with comma)
...
- [ ] Option B: Use integer volume everywhere (4 cc) -- the decimal is unnecessary precision
...
- [ ] Option B: Standardise to 10 for all exams
...
- [ ] Option A: Use pe12week style (AddFullStop for separation, auto-capitalise "Other" text)
...
- [ ] Option A: Always show "0 days" -- "20 weeks 0 days" is clearer
...
| Feature | earlyT1 | 20week | pe12week |
|---|---|---|---|
| Reports "not identified" | Yes | No | No |
| Reports "normal" | Yes ("Both ovaries are normal") | Yes, but returns empty if both are normal | No |
| Reports "abnormal" | Yes | Yes | Yes |
| Corpus luteum | Yes ("A corpus luteum is visualised in the right/left/both ovaries") | No (commented out -- note typo: "s visualised") | No |
| Abnormal text style | "The right ovary is abnormal." | "The right ovary is abnormal." | "Abnormal right ovary." |
| Formatting prefix | `#13#10 + #13#10` (blank line) | `#13#10+#13#10` (blank line) | `#13#10+#13#10 + '#|#+BOLDOvaries:#/#' + #13#10` (bold heading) |
...
- [ ] Option A: Use 20week style -- measurement inline: `"...long and closed, 30mm on TVS"`
...
- [ ] Option A: Keep separate -- pe12week uses it adverbially in its report template
...
- [ ] Option B: Use `.text <> ''` check (20week/t3Singleton) -- a value of 0 is meaningful and should be shown
- [ ] Other: _______________
...
- [ ] Option A: Use present tense ("is") for all exams
...
| Feature | 20week | pe12week | t3Singleton | t3twins |
|---|---|---|---|---|
| Low-lying text | `"Low lying placenta. Review of placental site at 32 weeks is indicated."` | Nothing | Low lying + site + measurement from os | `"Low lying placenta. Review of placental site at 32 weeks is indicated"` |
...
- [ ] Option A: Agreed -- use the gynae version with explicit type casts
